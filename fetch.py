...
if __name__ == "__main__":
    ...
    parser.add_argument("-tmpc", "--tmp_folder_check", default="/home/chakras4/OneDrive/Chakras4/SuperDARN-Data-Share/{user}/Downloaded/", help="Local folder to save files", type=str)
    parser.add_argument("-tmps", "--tmp_folder_store", default="/home/chakras4/OneDrive/Chakras4/SuperDARN-Data-Share/{user}/", help="Local folder to save files", type=str)
