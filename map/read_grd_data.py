...
class ReadGrdData(object):
    ...
    def save_to_ascii(self):
        ...
        for _file in self.file_list:
            ...
            if self.file_type=="grid2": rec_list = reader.read_grid()
            if self.file_type=="map2": rec_list = reader.read_map()
...
if __name__ == "__main__":
    ...
    end_date = datetime.datetime(2014,2,19)
    hemi = ["north", "south"]
    grd_obj = ReadGrdData(start_date, end_date, hemi=hemi, out_dir=fetcher + "/")
